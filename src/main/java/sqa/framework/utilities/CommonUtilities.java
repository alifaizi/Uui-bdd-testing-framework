...
import sqa.framework.base.BaseSetup;
...
public class CommonUtilities extends BaseSetup {
	...
	/**
	 * This method use to Click on And Element Useful when using @FindBy
	 * 
	 * @param element
	 */
	...
	/**
	 * this method is doing click action Useful when Using By Locator.
	 * 
	...
	/**
	 * This method is to get the text of element. Useful when using @FindBy
	 * 
	 * @param element
	...
	public void assertElementDisabled(By elementLocator) {
		...
		// element.isEnables. will return true if that element is enable otherwise will
		// return false.
